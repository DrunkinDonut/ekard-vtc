	...
	<body>
		...
		<section>
			...
			<?php
				...
				$earnedMoney = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(EarnedMoney) FROM routes WHERE Login = '$login' AND Status = 'Zatwierdzona';"));
				...
				$allDistance = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Distance) FROM routes WHERE Login = '$login' AND Status = 'Zatwierdzona';"));

				$allFuelConsumption = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Fuel) FROM routes WHERE Login = '$login' AND Status = 'Zatwierdzona';"));

				$avgFuelConsumption = mysqli_fetch_row(mysqli_query($conn, "SELECT (SUM(Fuel) / SUM(Distance)) * 100 FROM routes WHERE Login = '$login' AND Status = 'Zatwierdzona';"));

				$allRoutes = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*)+(SELECT AddedRoutesEts2 + AddedRoutesAts FROM users WHERE Login = '$login') FROM routes WHERE Login = '$login' AND Status = 'Zatwierdzona';"));

				$allDistanceEts2 = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Distance) FROM routes WHERE Login = '$login' AND Game = 'ets2' AND Status = 'Zatwierdzona';"));

				$allFuelConsumptionEts2 = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Fuel) FROM routes WHERE Login = '$login' AND Game = 'ets2' AND Status = 'Zatwierdzona';"));

				$avgFuelConsumptionEts2 = mysqli_fetch_row(mysqli_query($conn, "SELECT (SUM(Fuel) / SUM(Distance)) * 100 FROM routes WHERE Login = '$login' AND Game = 'ets2' AND Status = 'Zatwierdzona';"));

				$allRoutesEts2 = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*)+(SELECT AddedRoutesEts2 FROM users WHERE Login = '$login') FROM routes WHERE Login = '$login' AND Game = 'ets2' AND Status = 'Zatwierdzona';"));

				$allDistanceAts = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Distance) FROM routes WHERE Login = '$login' AND Game = 'ats' AND Status = 'Zatwierdzona';"));

				$allFuelConsumptionAts = mysqli_fetch_row(mysqli_query($conn, "SELECT SUM(Fuel) FROM routes WHERE Login = '$login' AND Game = 'ats' AND Status = 'Zatwierdzona';"));

				$avgFuelConsumptionAts = mysqli_fetch_row(mysqli_query($conn, "SELECT (SUM(Fuel) / SUM(Distance)) * 100 FROM routes WHERE Login = '$login' AND Game = 'ats' AND Status = 'Zatwierdzona';"));

				$allRoutesAts = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(*)+(SELECT AddedRoutesAts FROM users WHERE Login = '$login') FROM routes WHERE Login = '$login' AND Game = 'ats' AND Status = 'Zatwierdzona';"));
			...
			<div class="index_stats_top_group">
				...
				<div class="index_stats_top_block">
					...
					<div class="index_stats_top_table">
						...
						<h3>Dla przebiegu powyżej 5&nbsp;000km <a href="index" title="Pokaż mniej"><i class="fas fa-chevron-circle-up"></i></a></h3>
				...
				<div class="index_stats_top_block">
					...
					<div class="index_stats_top_table">
						...
						<h3>&nbsp;<a href="index" title="Pokaż mniej"><i class="fas fa-chevron-circle-up"></i></a></h3>
				...
				<div class="index_stats_top_block">
					...
					<h2>TOP NAJNIŻSZE SPALANIE | MIESIĄC</h2>
					...
					<div class="index_stats_top_table">
						...
						<h3>Dla przebiegu powyżej 20&nbsp;000km <a href="index" title="Pokaż mniej"><i class="fas fa-chevron-circle-up"></i></a></h3>
				...
				<div class="index_stats_top_block">
					...
					<h2>TOP PRZEBIEGI | MIESIĄC</h2>

					<div class="index_stats_top_table">

						<?php

							$topDistanceMonth = mysqli_query($conn, "SELECT DISTINCT Login, (SELECT SUM(Distance) FROM routes AS r1 WHERE r1.Login = r2.Login AND Status = 'Zatwierdzona' AND (Id < 42 OR Id > 43) AND DATE(DateAndTime) >= '$firstDayOfMonth' AND DATE(DateAndTime) <= '$lastDayOfMonth') AS Dystans FROM routes AS r2 WHERE (Id < 42 OR Id > 43) AND DATE(DateAndTime) >= '$firstDayOfMonth' AND DATE(DateAndTime) <= '$lastDayOfMonth' AND (SELECT SUM(Distance) FROM routes AS r1 WHERE r1.Login = r2.Login AND Status = 'Zatwierdzona') >= 20000 AND Status = 'Zatwierdzona' ORDER BY Dystans DESC LIMIT 50");
